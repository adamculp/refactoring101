 ...
 * to its own method, as well as the added bonus points for new releases.  We put it
 * in the Rental class because it rightly belongs with, and uses, the Rental data.
 * 
 */

namespace Refactoring007;
